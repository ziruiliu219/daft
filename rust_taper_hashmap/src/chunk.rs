...
/// Layout: [tags: 8B][keys: 64B][values: 48B][padding: 8B]
#[repr(C, align(128))]
pub struct Chunk {
    pub tags: [u8; SLOTS_PER_CHUNK],
    pub keys: [u64; SLOTS_PER_CHUNK],
    pub values: [SlotValue; SLOTS_PER_CHUNK],
    _padding: [u8; CHUNK_SIZE - 8 - 64 - 48],
}
